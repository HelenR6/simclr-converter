...
naes = datasets.ImageFolder(root="/content/gdrive/MyDrive/imagenet-r", transform=test_transform)
...
def validate(val_loader, model, criterion, args):
    ...
    with torch.no_grad():
        ...
        for i, (images, target) in enumerate(val_loader):
            ...
            # compute output
            output = model(images)[:,imagenet_r_mask]
    ...
    np.save('/content/gdrive/MyDrive/model_OOD_acc/imagenet-r/simclr.npy',top1.avg)
    return top1.avg
